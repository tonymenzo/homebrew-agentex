class Agentex < Formula
  ...
  url "https://github.com/tonymenzo/agenTeX/archive/refs/tags/v0.1.5.tar.gz"
  sha256 "0ec6a6a77dd4f77b36047add2e7a71c66fbea18c059ffdf705567001ba927c49"
  license "MIT"

  bottle do
    root_url "https://github.com/tonymenzo/homebrew-agentex/releases/download/agentex-0.1.5"
    sha256 cellar: :any, arm64_sonoma: "0c5609db699d5657077e2b22d2c68fd4e5ec7e73192228af886aae750196bf78"
  end
