class Agentex < Formula
  ...
  url "https://github.com/tonymenzo/agenTeX/archive/refs/tags/v0.1.7.tar.gz"
  sha256 "fb458e0e7f9b83bde2ce148b5932c0c657a09e730d638b08b7d1e9dab9bc0e37"
  license "MIT"

  bottle do
    root_url "https://github.com/tonymenzo/homebrew-agentex/releases/download/agentex-0.1.7"
    sha256 cellar: :any, arm64_sonoma: "15a0d9611dfb914cbbcbcd99623e70a69f788e9afd059957bc2e6684c5779838"
  end
  ...
  resource "orchestral-ai" do
    url "https://files.pythonhosted.org/packages/a2/eb/a3187242a2cc9b7aa60530d0bd0e1d24cfbf7e4b6896071820da4c7e8327/orchestral_ai-1.6.1.tar.gz"
